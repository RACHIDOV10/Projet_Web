...
<head>
  ...
  <title> تفاصيل تقرير البحث</title>
  ...
  <style>
    ...
    .breadcrumb {
      justify-content: flex-start !important; /* عكس اتجاه breadcrumb للغة العربية */
    }
  </style>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <?php $searchby = htmlspecialchars($_POST['searchinput'], ENT_QUOTES, 'UTF-8'); ?>
            <h1>تفاصيل تقرير البحث عن "<?php echo $searchby;?>"</h1>
          </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">تفاصيل تقرير البحث</h3>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $searchby = mysqli_real_escape_string($con, $_POST['searchinput']);
                    $ret = mysqli_query($con, "SELECT * FROM tblbooking WHERE BookingID LIKE '%$searchby%' OR ContactName LIKE '%$searchby%'");
                    $cnt = 1;
